...
public class RequestParameterConst {
    ...
    public static final String NEW_USER_PASSWORD_CHECKED = "passwordForCheck";
    public static final String USER_NAME = "name";
    public static final String MEDICAMENT_ID = "medicamentId";
    public static final String COUNT_MEDICAMENT = "count";
    ...
    public static final String LIST_MEDICINES = "medicines";
