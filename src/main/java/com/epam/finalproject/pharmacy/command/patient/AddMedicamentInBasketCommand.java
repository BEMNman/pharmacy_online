...
public class AddMedicamentInBasketCommand implements Command {
    ...
    public CommandResult execute(HttpServletRequest request) throws ServerException {
        ...
        Map<Medicament, Integer> medicamentCountMap = (Map) session.getAttribute(SessionAttributeConst.MEDICINES_IN_BASKET);
        ...
        String messageResultCommand = service.addMedicamentInBasket(user, stringMedicamentId, stringCount, medicamentCountMap);
        ...
        request.setAttribute(RequestParameterConst.PAGE, page);
